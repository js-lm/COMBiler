                ...
                ProjectData::Page{
                    .instrumentChannels{
                        ProjectData::InstrumentChannel{
                            ...
                            music_data::Note::D4,
                            music_data::Instrument::Church_Organ,
                            music_data::Note::C4,
                            music_data::Instrument::Music_Box,
                            music_data::Note::D4,
                            music_data::Instrument::Tubular_Bells,
                            music_data::Note::E4,
                            music_data::Instrument::Vibraphone,
                            music_data::Note::E4,
                            music_data::Instrument::Clarinet,
                            music_data::Note::E4,
                            music_data::Instrument::Violin,
                            music_data::Note::D4,
                            music_data::Instrument::Cello,
                            music_data::Note::D4,
                            music_data::Instrument::Orchestral_Harp,
                            music_data::Note::D4,
                            music_data::Instrument::Tuba,
                            music_data::Note::E4,
                            music_data::Instrument::Choir_Aahs,
                            music_data::Note::G4,
                            music_data::Instrument::Finger_Bass,
                            music_data::Note::G4,
                            music_data::Instrument::Tenor_Saxophone,
                            music_data::Note::E4,
                            music_data::Instrument::Pad_1_Fantasia,
                            music_data::Note::D4,
                            music_data::Instrument::Steel_Drum,
                            music_data::Note::C4
                        },
                        ProjectData::InstrumentChannel{
                    ...
                    .commandChannel{
                        ...
                        std::nullopt,
                        command::Command{command::Articulation{units::machine::Articulation::Staccato, command::Target::Channel_4}},
                        std::nullopt,
                        command::Command{command::Tempo{26}},
                        std::nullopt,
                        command::Command{command::Volume{1, command::Target::All_Channels}},
                        std::nullopt,
                        command::Command{command::Articulation{units::machine::Articulation::Legato, command::Target::Channel_3}},
                        std::nullopt,
                        command::Command{command::Volume{15, command::Target::Channel_1}},
                        std::nullopt,
                        command::Command{command::Tempo{60}},
                        std::nullopt,
                        command::Command{command::Articulation{units::machine::Articulation::Normal, command::Target::All_Channels}},
                        std::nullopt,
                        command::Command{command::Volume{4, command::Target::Channel_4}},
                        std::nullopt,
                        command::Command{command::Tempo{100}},
                        std::nullopt,
                        command::Command{command::Articulation{units::machine::Articulation::Sustain, command::Target::Channel_1}},
                        std::nullopt,
                        command::Command{command::Volume{5, command::Target::Channel_3}},
                        std::nullopt,
                        command::Command{command::Articulation{units::machine::Articulation::Infinite, command::Target::Channel_2}},
                        std::nullopt,
