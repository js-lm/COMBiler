...
namespace constants::labels::prompts{
    ...
    constexpr const char *MusicSettingModifiedLabelText{"Modified:"};
    constexpr const char *MusicSettingVersionLabelText{"Version:"};
    constexpr const char *MusicSettingLineText{nullptr};
